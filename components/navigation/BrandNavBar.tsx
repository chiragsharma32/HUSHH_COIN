...
import { LayoutDashboard, Plus, Wallet, BarChart3, Settings } from "lucide-react";
import { motion } from "framer-motion";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/brand/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/brand/campaigns", label: "Campaigns", icon: Plus },
...
export default function BrandNavBar() {
  ...
  // Don't show nav on brand landing page
  if (pathname === "/brand") {
    return null;
  }
